...
import { assertRecTemplate } from './helpers/scaffoldAssertions';
...
tmpdirTest('assert rec template', ({ dir }) => {
  execaCommandSync('npm create react-creative my-app -- --template rec', {
    cwd: dir,
